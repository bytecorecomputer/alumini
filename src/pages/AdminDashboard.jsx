                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {loading ? (
                                <tr><td colSpan="4" className="p-8 text-center text-gray-500">Loading DB...</td></tr>
                                    ...
                                    >
                                        <td className="p-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-gray-900">{u.displayName || "Unknown"}</p>
                                        ...
                                        <td className="p-4 text-sm text-gray-500">
                                            {u.company && <div className="flex items-center gap-1"><Briefcase size={12} /> {u.company}</div>}
                                            {u.course && <div className="flex items-center gap-1"><GraduationCap size={12} /> {u.course}</div>}
                                        </td>
                                        <td className="p-4 text-right space-x-2 flex justify-end items-center">

                                            <button
                                                onClick={() => handleEditClick(u)}
                                                className="text-gray-500 hover:text-blue-600 transition-colors p-1.5 bg-gray-100 rounded-lg"
                                                title="Edit Details"
                                            >
                                                <Edit3 size={16} />
                                            </button>
                                            ...
                                            {u.role !== 'admin' && u.role !== 'super_admin' ? (
                                                <button
                                                    ...
                                                    className="text-xs font-semibold bg-purple-50 text-purple-700 px-3 py-1.5 rounded-lg hover:bg-purple-100 border border-purple-200 transition-colors"
                                                >
                                                    Make Admin
                                                </button>
                                            ) : u.role === 'admin' ? (
                                                <button
                                                    ...
                                                    className="text-xs font-semibold bg-gray-50 text-gray-700 px-3 py-1.5 rounded-lg hover:bg-gray-100 border border-gray-200 transition-colors"
                                                >
                                                    Remove Admin
                                                </button>
                                            ) : null}
