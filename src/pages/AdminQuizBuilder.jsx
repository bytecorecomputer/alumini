            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-20">
                {showQuizList ? (
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-xl text-blue-800 border border-blue-100">
                            <AlertCircle className="shrink-0 text-blue-600 mt-0.5" size={20} />
